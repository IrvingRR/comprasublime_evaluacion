      ...
      <div class="header"> 
        ...
        <ul>
          @if(kvfj(Auth::user()->permissions, 'products_add'))
            <li>
              <a href="{{url('/admin/product/add')}}"><i class="fas fa-plus"></i> Agregar producto nuevo</a> 
            </li>
          @endif
          <li>
              ...
              <td>
                <div class="opts">
                  ...
                  @if(kvfj(Auth::user()->permissions, 'products_delete'))
                    ...
                    <a href="#" data-path="admin/products" data-action="delete" data-object="{{$p->id}}" title="Eliminar" class="btn-deleted"><i class="fas fa-trash-alt"></i></a>
                    @else
                    <a href="{{ url('/admin/products/'.$p->id.'/restore') }}" data-action="restore" data-path="admin/products" data-object="{{$p->id}}" title="Restaurar" class="btn-deleted"><i class="fas fa-trash-restore"></i></a>
                    @endif
                  @endif
                </div>
              </td>
