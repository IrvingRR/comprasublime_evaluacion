  ...
  <div class="container-fluid">
    <div class="row">
      <div class="col-md-3">
        <div class="panel shadow">
          ...
          <div class="inside">
            ...
            {!! Form::open(['url' => '/admin/category/add/'.$section, 'files' => true]) !!}
            ...
            <label for="section" class="mtop16">Categoría padre:</label>
            <div class="input-group">
              <div class="input-group-prepend">
                <span class="input-group-text" id="basic-addon1"><i class="fas fa-keyboard"></i></span>
              </div>
            ...
            <div class="input-group">
              ...
              {!! Form::select('section', getModuleArray(), $section, ['class' => 'form-select', 'disabled']) !!}
            </div>
      ...
      <div class="col-md-9">
        <div class="panel shadow">
          <div class="header">
            <h2 class="title"><i class=" fas fa-folders"></i>Categorias</h2>
          </div>
          <div class="inside">
                ...
                <tr>
                  ...
                  <td>
                    <div class="opts">
                      ...
                      <a href="{{ url('/admin/category/'.$cat->id.'/subs') }}" title="Subcategorias"><i class="fas fa-list-ul"></i></a>
                      @endif
