...
<div class="contenedorContent">
    <div class="row mtop32">
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <div class="input-group mtop16">
                                    <span class="input-group-text" id="addon-wrapping"><i class="fas fa-keyboard"></i></span>        
        ...
        <div class="col-md-8">
            <div class="panel shadow">
                <div class="header">
                    <h2 class="title"><i class="fas fa-address-card"></i> Editar inforamción</h2>
                </div>
                <div class="inside">
                    {!! Form::open(['url' => '/account/edit/info']) !!}
                       ...
                       <div class="row mtop16">
                        ...
                        <div class="col-md-4">
                           ...
                           <div class="col-md-8">
                            <label for="name">Fecha de nacimiento: Año - Mes - Día</label>
                            <div class="input-group mtop16">
                                <span class="input-group-text" id="addon-wrapping"><i class="fas fa-keyboard"></i></span>        
                       ...
                       <div class="row mtop16">
                           <div class="col-md-12">
                               {!! Form::submit('Guardar', ['class' => 'btn btn-primary mtop16']) !!}
                           </div>
                       </div>
                    {!! Form::close() !!}
                </div>
