...
class UserController extends Controller
{
  ...
  public function postUserEdit(Request $request, $id) {
    ...
    if($u->save()):
      if($request->input('user_type') == "1"):
        return redirect('/admin/user/'.$u->id.'/permissions')->with('message', 'El rango de usuario fue actualizado exitosamente')->with('typealert', 'success');
      else:
        return back()->with('message', 'El rango de usuario fue actualizado exitosamente')->with('typealert', 'success');
      endif;
    endif;
  }
